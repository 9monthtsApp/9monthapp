...
public class watch_tests_results extends AppCompatActivity {
    ...
    private Button explanationsButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        explanationsButton =(Button) findViewById(R.id.seeTestInfo) ;
        ...
        explanationsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openGeneralInfo_blood();
            }
        });
    ...
    private void openGeneralInfo_blood() {
    ...
    private void checkValuesGlucose( String[] str){
        ...
        } else if (Double.valueOf(str[13]) > 130.0) {
